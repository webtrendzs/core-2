...
$GLOBALS['TL_LANG']['tl_iso_document']['fileTitle']                 = array('File title', 'You can use simple tokens ("collection_*" whereas * equals the database column of the collection) to render your file title.');
$GLOBALS['TL_LANG']['tl_iso_document']['template']                  = array('Template', 'Choose a template you want to render this document with.');
